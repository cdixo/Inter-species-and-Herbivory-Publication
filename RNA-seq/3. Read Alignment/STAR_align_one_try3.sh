...
#SBATCH --job-name=STAR_align_one_try3.sh_11-1-22
#SBATCH --time=0:30:00
#SBATCH --nodes=1
...
output_dir=/fs/ess/PAS1444/IH_Timecourse_V1_RNA-seq/work_dir/STAR/STAR_align_one/bam      # output directory which will contain a finalized, sorted .bam .bam file
