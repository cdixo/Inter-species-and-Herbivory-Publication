...
#SBATCH --job-name=STAR_index_try2_11-1-22
#SBATCH --time=2:00:00
#SBATCH --nodes=1
...
input_fasta=/fs/ess/PAS1444/IH_Timecourse_V1_RNA-seq/work_dir/labrusca.V1.fasta      # reference genome FASTA file (input)
ref_gtf=/fs/ess/PAS1444/IH_Timecourse_V1_RNA-seq/work_dir/Vitis_labrusca_annoV2.gtf	 # genome annotation file
output_dir=/fs/ess/PAS1444/IH_Timecourse_V1_RNA-seq/work_dir/STAR/STAR_index         # Output dir for the indexed genome
