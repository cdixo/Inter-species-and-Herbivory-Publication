...
#SBATCH --job-name=STAR_align_all_try4.sh_11-2-22
...
sample_list=/fs/ess/PAS1444/IH_Timecourse_V1_RNA-seq/work_dir/samples.txt                 # the txt file which lists which samples (transcriptome samples) which the above command should look for to then feed into STAR
...
output_dir=/fs/ess/PAS1444/IH_Timecourse_V1_RNA-seq/work_dir/STAR/STAR_align/bam          # output directory which will contain a finalized, sorted .bam .bam file
