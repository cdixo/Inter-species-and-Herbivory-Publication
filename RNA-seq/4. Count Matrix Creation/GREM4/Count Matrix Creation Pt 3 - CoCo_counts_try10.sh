...
#SBATCH --job-name=CoCo_counts_try10.sh_11-20-22
...
coco_correct_gtf_file=/fs/ess/PAS1444/IH_Timecourse_V1_RNA-seq/work_dir/CoCo/Vitis_labrusca_annoV2.cococorrectannoout.gtf   # genome annotation file which is the output from the 'coco correct_annotation' command
bam_input_files=/fs/ess/PAS1444/IH_Timecourse_V1_RNA-seq/work_dir/STAR/STAR_align/bam/ 										# input file directory (the real deal .bam files) in .bam format
output_location=/fs/ess/PAS1444/IH_Timecourse_V1_RNA-seq/work_dir/CoCo/														# output location (just location, not the name of the output file, that comes in the for loop)
